...
export default function UserLogin() {
    return (
        <div className="min-h-dvh pt-28 px-4 md:px-8 lg:px-16 bg-backGroundColor">
                ...
                <div className="flex flex-col gap-5 items-center w-full xmd:w-lg lg:w-xl px-4 xmd:px-8 py-8">
                    <form action="" className='w-full'>
                        <header className='text-center'>
                            <h1 className='text-3xl font-bold text-textColor'>أهلاً بك</h1>
                            <p className='text-lg text-paragraphTextColor'>سجّل دخولك للمتابعة</p>
                        </header>
                    ...
                    <div className="flex flex-row gap-1 text-textColor">
                        <Link to="/userSignUp">
                            ...
                            <span className='text-mainColor cursor-pointer'>إنشاء حساب</span>
                        </Link>
                    </div>
                </div>
            </div>
